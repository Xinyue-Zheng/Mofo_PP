#!/usr/bin/env bash
# run_adaptive_weather.sh — Ablation 2: adaptive per-channel period, no channel attention
...
for HORIZON in 96 192 336 720; do
    echo "=== [Adaptive period] horizon=${HORIZON} ==="
    python ./scripts/run_benchmark.py \
        ...
        --num-workers 1 \
        --timeout 60000 \
        --save-path "Weather/MoFo_adaptive_h${HORIZON}"
done
